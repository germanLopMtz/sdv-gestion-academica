...
{
    /// <inheritdoc />
    public partial class AddHorariosModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_MaestroId",
                column: "MaestroId");
            ...
            // Insertar datos iniciales de aulas
            ...
            // Insertar datos iniciales de horarios PM
            migrationBuilder.Sql(@"
                INSERT INTO TimeSlots (StartTime, EndTime, DisplayName) VALUES 
                ('15:00', '17:00', '3:00-5:00 PM'),
                ('17:30', '19:30', '5:30-7:30 PM'),
                ('20:00', '22:00', '8:00-10:00 PM');
            ");
        }
